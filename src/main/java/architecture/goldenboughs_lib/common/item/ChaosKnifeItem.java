...
/// 混沌刀
public class ChaosKnifeItem extends SwordItem implements IMeleeEgoWeaponItem, IItemLcDamageType {
	...
	public ChaosKnifeItem(Properties itemProperties, Builder builder) {
		super(new SimpleTier(BlockTags.INCORRECT_FOR_IRON_TOOL, 0, builder.getAttackSpeed(), builder.getWeaponDamage(), 5, Ingredient::of),
