...
public final class LibCapabilitys {
	...
	public static final ItemCapability<IItemUsageReq, Void> USAGE_REQ_ITEM =
		ItemCapability.createVoid(Lib.modRl("usage_req_item"), IItemUsageReq.class);

	public static final ItemCapability<IItemLcDamageType, Void> LC_DAMAGE_TYPE_ITEM =
		ItemCapability.createVoid(Lib.modRl("lobotomy_corporation_damage_type_item"), IItemLcDamageType.class);
	...
	public static class LcLevel {
		public static final ItemCapability<IItemLcLevel, Void> LC_LEVEL_ITEM =
			ItemCapability.createVoid(Lib.modRl("lobotomy_corporation_level_item"), IItemLcLevel.class);

		public static final BlockCapability<IBlockLcLevel, Void> LC_LEVEL_BLOCK =
			BlockCapability.createVoid(Lib.modRl("lobotomy_corporation_block_block"), IBlockLcLevel.class);

		public static final EntityCapability<IEntityLcLevel, Void> LC_LEVEL_ENTITY =
			EntityCapability.createVoid(Lib.modRl("lobotomy_corporation_level_entity"), IEntityLcLevel.class);
	}
}
