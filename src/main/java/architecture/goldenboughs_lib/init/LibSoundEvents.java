...
public final class LibSoundEvents {
	public static final DeferredRegister<SoundEvent> REGISTRY = Lib.modRegister(BuiltInRegistries.SOUND_EVENT);

	private static DeferredHolder<SoundEvent, SoundEvent> registerForHolder(String id, String zhName, String location) {
		DeferredHolder<SoundEvent, SoundEvent> register = REGISTRY.register(id, () -> SoundEvent.createVariableRangeEvent(Lib.modRl(location)));
