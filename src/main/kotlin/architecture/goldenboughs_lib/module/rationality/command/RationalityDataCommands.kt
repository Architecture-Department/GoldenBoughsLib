package architecture.goldenboughs_lib.module.rationality.command
...
import architecture.goldenboughs_lib.module.rationality.util.RationalityUtil.getNaturalRecoveryRate
import architecture.goldenboughs_lib.module.rationality.util.RationalityUtil.getRationalityRecoveryAmount
import architecture.goldenboughs_lib.module.rationality.util.RationalityUtil.getRationalityValue
import architecture.goldenboughs_lib.module.rationality.util.RationalityUtil.setBaseMaxValue
import architecture.goldenboughs_lib.module.rationality.util.RationalityUtil.setBaseNaturalRecoveryRate
import architecture.goldenboughs_lib.module.rationality.util.RationalityUtil.setBaseRationalityRecoveryAmount
import architecture.goldenboughs_lib.module.rationality.util.RationalityUtil.setRationalityValue
