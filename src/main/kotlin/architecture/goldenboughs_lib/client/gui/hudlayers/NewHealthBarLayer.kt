...
class NewHealthBarLayer : StatusBarLayer(
	...
	companion object {
		@JvmField
		val LIGHT_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/light")

		// 伤害吸收
		@JvmField
		val ABSORBING_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/absorbing")

		@JvmField
		val ABSORBING_LIGHT_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/absorbing_light")

		// 冰冻
		@JvmField
		val FROZEN_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/frozen")

		@JvmField
		val FROZEN_BOTTOM_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/frozen_bottom")

		// 正常
		@JvmField
		val FULL_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/full")

		@JvmField
		val FULL_BOTTOM_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/full_bottom")

		// 凋零
		@JvmField
		val WITHERED_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/withered")

		@JvmField
		val WITHERED_BOTTOM_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/withered_bottom")

		// 中毒
		@JvmField
		val POISIONED_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/poisioned")

		@JvmField
		val POISIONED_BOTTOM_TEXTURE: ResourceLocation = LibConstants.modRl("hud_bar/health/poisioned_bottom")
